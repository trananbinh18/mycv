...
export const timeLineData = {
    ...
    "Project: Estate Investment": { type: "Project", tech: ["ASP.NET CORE", "Entity Framework Core", "React JS"], time: "12/07/2019", content: ["Work as Developer, Team size: 2 member", "Build website investing estate project", "Reasearch about .NET Core and React JS", "Research about Code First approach using migration"] },
    ...
    "Project: Currency": { type: "Project", time: "02/03/2020 ~ now", tech: ["Java", "Android SDK", "Signleton"], content: ["Work as Developer, Team size: 10 member", "Build App and Widget for tracking exchange rate for currency", "Updating UI/UX to fit requirement", "Research about Widget work flow in android system", "Implement Signleton pattern", "Implement callback interface per-action", "Using HTTP Client Retrofit"] },
    "Project: Weather": { type: "Project", time: "02/03/2020 ~ now", tech: ["Java", "Android SDK", "Signleton"], content: ["Work as Developer, Team size: 10 member", "Build App and Widget for weather forecast", "Updating UI/UX to fit requirement", "Implement Signleton pattern", "Implement callback interface per-action", "Implement HTTP Client Retrofit"] },
    "Project: News": { type: "Project", time: "02/03/2020 ~ now", tech: ["Java", "Android SDK", "Signleton"], content: ["Work as Developer, Team size: 10 member", "Build App for fetching newspager", "Updating UI/UX to fit requirement", "Implement Signleton pattern", "Implement callback interface per-action", "Implement HTTP Client Retrofit"] },

    "Project: Phistu": { type: "Project", time: "22/09/2020", tech: ["Wordpress", "PHP"], content: ["Work as Developer Team size: 2 member", "Build website for school", "Using HTML, CSS, JS to update web font-side", "Reading implementation of wordpress theme to edit PHP code"] },
    "Self Project: Give and Get App": { type: "Project", time: "27/09/2020", tech: ["C#", "Java", "Android SDK", "ASP.NET", "MSSQL"], content: ["Work as Developer Team size: 2 member", "Website and app social network for giving and getting stuff", "Find the way to store Image in database", "Research Notification work flow android system"] },
    "Project: LMS Canvas": { type: "Project", time: "12/11/2020 ~ 23/05/2021", tech: ["Kotlin", "Android SDK", "Docker", "AWS EC2"], content: ["Work as Developer, Dev-Op Team size: 3 member", "Opensource LMS for monitor, manage, operate all about learning stuff for K12 school", "Reading code from LMS applications and modify it to fit requirements", "Research Dart, Flutter and Kotlin to understand the app structure and modify to fit requirement", "Using AWS EC2 to deploy, config and setup web-server", "Research about SSO and OAuth 2", "Deploy and setup keycloak Identity server open-source", "Using docker to deploy system in containers"] },
